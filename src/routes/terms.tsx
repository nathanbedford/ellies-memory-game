        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-600">
              By accessing and using Matchimus ("the Game"), you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p className="text-gray-600">
              Matchimus is a memory card matching game that can be played locally on a single device or
              online with another player. The Game is provided free of charge for personal, non-commercial use.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-800 mt-8 mb-4">3. User-Provided Content</h2>
            <p className="text-gray-600">
              The Game allows you to enter player names of your choosing. You agree that any names you enter:
            </p>
            ...
            <p className="text-gray-600 mt-2">
              Player names entered during online play may be visible to other players in your game session.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              All content within the Game, including but not limited to graphics, designs, and code,
              is owned by Avodah Transformations LLC and is protected by intellectual property laws.
              You may not copy, modify, distribute, or create derivative works from the Game without
          ...
          <section>
            ...
            <p className="text-gray-600">
              ...
              We do not guarantee that the Game will be uninterrupted, error-free, or free of viruses
          ...
          <section>
            ...
            <p className="text-gray-600">
              To the fullest extent permitted by law, Avodah Transformations LLC shall not be liable
