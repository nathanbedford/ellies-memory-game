...
export const Pong = ({ isOpen, onClose }: PongProps) => {
  ...
  useEffect(() => {
    ...
    gameStateRef.current = {
      ...
      ball: { x: canvas.width / 2, y: canvas.height / 2, vx: INITIAL_BALL_SPEED, vy: INITIAL_BALL_SPEED },
      keys: { w: false, s: false, ArrowUp: false, ArrowDown: false },
    };
    ...
    const gameLoop = () => {
      ...
      ctx.fillRect(width - PONG_WIDTH, state.rightPaddle.y, PONG_WIDTH, PONG_HEIGHT);
