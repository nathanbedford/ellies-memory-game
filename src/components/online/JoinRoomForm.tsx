...
export const JoinRoomForm = ({ onJoin, onBack, isLoading = false, error }: JoinRoomFormProps) => {
  ...
  return (
    <div className="text-center space-y-6">
      <div>
        ...
        <p className="text-gray-600">Enter the 4-letter room code from your friend</p>
      </div>
