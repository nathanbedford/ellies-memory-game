			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
				...
				>
					<div className="space-y-4">
						<div className="flex justify-center">
							<svg
								className="w-16 h-16 text-blue-500 transition-transform group-hover:scale-110"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 64 64"
								aria-label="Same device icon"
							>
						...
						<p className="text-gray-600 text-sm">
							Play with a friend on the same screen. Take turns finding matches
							together!
						</p>
					</div>
				</button>
				...
				>
					<div className="space-y-4">
						<div className="flex justify-center">
							<svg
								className="w-16 h-16 text-purple-500 transition-transform group-hover:scale-110"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 64 64"
								aria-label="Play online icon"
							>
								...
								<path
									strokeLinecap="round"
									strokeWidth={1.5}
									d="M20 10c2 2 3 4 4 7"
									opacity={0.6}
								/>
								<path
									strokeLinecap="round"
									strokeWidth={1.5}
									d="M17 14c3 2 5 5 6 9"
									opacity={0.4}
								/>
								...
								<path
									strokeLinecap="round"
									strokeWidth={1.5}
									d="M44 54c-2-2-3-4-4-7"
									opacity={0.6}
								/>
								<path
									strokeLinecap="round"
									strokeWidth={1.5}
									d="M47 50c-3-2-5-5-6-9"
									opacity={0.4}
								/>
								{/* Connection sparkles */}
								<circle
						...
						<p className="text-gray-600 text-sm">
							Challenge a friend over the internet. Share a room code to
							connect!
						</p>
					</div>
				</button>
