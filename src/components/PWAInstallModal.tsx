				...
				<div className="p-6">
					<div className="space-y-4 mb-6">
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm opacity-95">
										The installed version prevents unwanted scrolling and
										handles fullscreen mode much better, giving you the best
										gameplay experience.
									</p>
								</div>
							</div>
						...
						<div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
							...
							<ol className="list-decimal list-inside space-y-2 text-sm text-blue-800">
								<li>
									...
									in Safari (at the top or bottom of the screen, depending on
									your iPad version)
								</li>
								<li>
						...
						<p className="text-sm text-gray-600">
							Once installed, you can launch Matchimus directly from your home
