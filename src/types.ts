...
export type CardPack = 'animals' | 'animals-real' | 'plants' | 'buildings' | 'colors' | 'ocean' | 'ocean-real' | 'construction' | 'emotions-real' | 'insects-real' | 'jungle-animals-real' | 'plush-cute-animals-real';
