...
import type { CardPack, CardPackOption } from "../types";
 ...
 */
export function getRandomCardSubset(
	images: CardImage[],
	pairCount: number,
): CardImage[] {
...
export const useCardPacks = () => {
	...
	const getCurrentPackImages = useCallback(
		() => currentPackImages,
		[currentPackImages],
	);
	 ...
	 */
	const getPackImagesForPairCount = useCallback(
		(pairCount: number): CardImage[] => {
